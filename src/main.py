...
from plots_ray_tracing import make_figure_5, make_figure_6
...
def main():
    ...
    # Fig 4: FDFD Kerr-Newman simulations (4 cases, b_inf = 3)
    make_figure_4()
    ...
    # Fig 6: Ray tracing - error analysis (Dn and DB0 scans)
    make_figure_6()
